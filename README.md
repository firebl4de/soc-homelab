...
| Machine | Role | OS | IP |
|---|---|---|---|
| Kali Linux | Attacker | Kali 2024 | 192.168.xxx.xx9 / 192.168.xxx.xx4 |
| Windows 10 Pro | Victim (domain-joined) | Windows 10 Pro | 192.168.xxx.xx3 |
| Windows Server 2016 | Domain Controller | Windows Server 2016 | 192.168.xxx.xx2 |
| CentOS | Splunk SIEM | CentOS 9 | 192.168.xxx.xx1 / 192.168.xxx.xx1 |

> **Note on IPs:** Windows endpoints are dual-homed. Early incidents (01–07) reference the NAT-side IP (192.168.xxx.xx0); domain-joined incidents (08–11) reference the host-only IP (192.168.xxx.xx3 / 192.168.xxx.xx2).
