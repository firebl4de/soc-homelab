...
**Analyst:** Sameep Ghelani  
**Date:** April 2026  
**Incidents:** 11 documented  
**Environment:** Kali → Windows 10 Pro / Windows Server 2016 → Splunk on CentOS  
**Framework:** MITRE ATT&CK  
**Tools:** Splunk, Sysmon, Wazuh (FIM), Impacket, Hydra, Netcat, Mimikatz, Nmap  
...
| Step | Action |
|---|---|
| 1. Alert Review | EID 4672 for an account that does not exist in AD. Confirm by running `Get-ADUser fakeadmin` on the DC — "cannot find object" confirms phantom account. |
